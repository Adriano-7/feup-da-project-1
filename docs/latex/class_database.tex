...
\begin{DoxyCompactList}\small\item\em Get the top \char`\"{}k\char`\"{} municipalities based on total flow. \end{DoxyCompactList}\item 
vector$<$ pair$<$ string, int $>$ $>$ \mbox{\hyperlink{class_database_a3bfdf09c2fd68938bb776d10f7fc9b07}{get\+Top\+Districts}} (int k)
\begin{DoxyCompactList}\small\item\em Get the top \char`\"{}k\char`\"{} districts based on total flow. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Checks the connection between stations. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Changes capacity from an edge. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
Changes capacity from an edge. 

Time Complexity\+: O() Passes on the arguments to the corresponding change\+Capacity function of the graph object, and returns its boolean result. 
...
Checks the connection between stations. 

Time Complexity\+: O() Passes on the arguments to the corresponding check\+Connection function of the graph object, and returns its boolean result. 
\begin{DoxyParams}{Parameters}
{\em station1} & \\
\hline
{\em station2} & \\
...
Get the top \char`\"{}k\char`\"{} districts based on total flow. 

Time Complexity\+: O(\+N$\ast$\+M) Calculates the maximum flow through sets of stations in each district, and returns a vector of the top k districts based on this flow metric. 
\begin{DoxyParams}{Parameters}
{\em k} & \\
\hline
\end{DoxyParams}
...
Get the top \char`\"{}k\char`\"{} municipalities based on total flow. 

Time Complexity\+: O(m(slog(s)+e) Returns a vector of the top k municipalities based on their total flow (sum of flow values) from all of their stations in a graph. 
\begin{DoxyParams}{Parameters}
{\em k} & \\
\hline
\end{DoxyParams}
